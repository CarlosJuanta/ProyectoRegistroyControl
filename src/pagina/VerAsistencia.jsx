...
const Asistencia = () => {
  ...
  // Función para sumar las asistencias con estado true
  const sumarAsistenciasTrue = (asistencias) => {
    return asistencias.filter((asistencia) => asistencia.estado).length;
  };
              ...
              <tr key={estudiante._id}>
                ...
                <td>
                  {selectedDate && (
                    ...
                    sumarAsistenciasTrue(
                      estudiante.asistencias.filter(
                        (asistencia) => asistencia.fecha === selectedDate
                      )
                    )
                  )}
                </td>
